...
const ask_soka = async (content) => {
  const response = await ai.models.generateContent({
    ...
    { role: "user", parts: [
      ...
      { text: "分かりやすく話せるように以下のことを意識してください。" },
      { text: "分からないことは適当に答えず分からないということ。" },
      { text: "推論や考察を話すときはまるで事実のようには語らず、必ず、推論・考察であることを言うこと。" },
      ...
      { text: "あなたは必ずしもソーカのコマンドを教えるbotとしてふるまわなくてもよいです。とにかく、ユーザーの質問第一です。" },
